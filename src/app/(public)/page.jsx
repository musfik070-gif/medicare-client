...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans">
      ...
      <motion.div
        className="hero min-h-[75vh] bg-gradient-to-br from-sky-50 via-white to-emerald-50 relative overflow-hidden"
          ...
          {homeData?.featuredDoctors?.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {homeData?.featuredDoctors?.map((doctor) => (
                <div
                  key={doctor._id}
                  className="card bg-white shadow-sm border border-slate-100 rounded-2xl flex flex-col h-full transition-all duration-300 hover:shadow-md hover:-translate-y-1 overflow-hidden"
                >
                  ...
                  <div className="card-body items-center text-center p-6 flex flex-col flex-grow">
                    <h2 className="card-title text-xl font-bold text-slate-800 mb-1">
                      {doctor.doctorName}
                    </h2>
                    <span className="badge bg-sky-50 text-sky-600 text-xs font-semibold px-3 py-1 rounded-full border border-sky-100 mb-3">
                      {doctor.specialization}
                    </span>
                    <div className="space-y-1.5 text-sm text-slate-500 mb-6 flex-grow">
                      <p className="flex items-center justify-center gap-1.5">
                        <span>Experience:</span>
                        <strong className="text-slate-700">{doctor.experience} years</strong>
                      </p>
                      <p className="flex items-center justify-center gap-1 text-emerald-600 font-semibold bg-emerald-50/50 px-3 py-1 rounded-lg border border-emerald-100/50 mt-2">
                    ...
                    <Link
                      ...
                      className="w-full text-center border border-sky-500 text-sky-500 hover:bg-sky-50 rounded-xl py-2.5 font-semibold transition-all duration-200 text-sm mt-auto"
                    >
                      View Profile
                    </Link>
                  </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl text-center">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
            ...
            <div className="card bg-white shadow-sm border border-slate-100 hover:bg-sky-500 hover:text-white transition-all duration-300 hover:shadow-md py-8 cursor-pointer group rounded-2xl">
              ...
              <h3 className="font-bold text-lg group-hover:text-white text-slate-800 transition-colors">Neurology</h3>
            </div>

            <div className="card bg-white shadow-sm border border-slate-100 hover:bg-sky-500 hover:text-white transition-all duration-300 hover:shadow-md py-8 cursor-pointer group rounded-2xl">
              <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-200">🦴</div>
              <h3 className="font-bold text-lg group-hover:text-white text-slate-800 transition-colors">Orthopedics</h3>
            </div>

            <div className="card bg-white shadow-sm border border-slate-100 hover:bg-sky-500 hover:text-white transition-all duration-300 hover:shadow-md py-8 cursor-pointer group rounded-2xl">
              <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-200">🧸</div>
              <h3 className="font-bold text-lg group-hover:text-white text-slate-800 transition-colors">Pediatrics</h3>
            </div>

            <div className="card bg-white shadow-sm border border-slate-100 hover:bg-sky-500 hover:text-white transition-all duration-300 hover:shadow-md py-8 cursor-pointer group rounded-2xl">
              <div className="text-4xl mb-4 group-hover:scale-110 transition-transform duration-200">✨</div>
              <h3 className="font-bold text-lg group-hover:text-white text-slate-800 transition-colors">Dermatology</h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {reviews.map((review) => (
              <div
                key={review._id}
                className="card bg-white shadow-sm hover:shadow-md transition-all duration-200 p-6 border border-slate-100 flex flex-col h-full rounded-2xl"
              >
                ...
                <p className="text-slate-600 italic text-sm mb-6 flex-grow leading-relaxed">
                ...
                <div className="flex items-center gap-3 mt-auto pt-4 border-t border-slate-50">
                  <div className="avatar placeholder">
                    <div className="bg-sky-50 text-sky-600 rounded-full w-10 h-10 flex items-center justify-center font-bold border border-sky-100 text-sm">
            ...
            <div className="md:w-1/2">
              ...
              <ul className="space-y-4">
                <li className="flex items-center gap-3 text-slate-700">
                  <span className="text-emerald-500 bg-emerald-50 w-7 h-7 flex items-center justify-center rounded-full text-base font-bold shadow-sm border border-emerald-100">✔</span>
                  <span><strong>Verified Specialists:</strong> Every doctor on our platform is thoroughly vetted.</span>
                </li>
                <li className="flex items-center gap-3 text-slate-700">
                  <span className="text-emerald-500 bg-emerald-50 w-7 h-7 flex items-center justify-center rounded-full text-base font-bold shadow-sm border border-emerald-100">✔</span>
                  <span><strong>Secure Medical Records:</strong> Your health records are safely stored.</span>
                </li>
                <li className="flex items-center gap-3 text-slate-700">
                  <span className="text-emerald-500 bg-emerald-50 w-7 h-7 flex items-center justify-center rounded-full text-base font-bold shadow-sm border border-emerald-100">✔</span>
                  <span><strong>Instant Online Booking:</strong> Pick a date and time that works for you.</span>
                </li>
                <li className="flex items-center gap-3 text-slate-700">
                  <span className="text-emerald-500 bg-emerald-50 w-7 h-7 flex items-center justify-center rounded-full text-base font-bold shadow-sm border border-emerald-100">✔</span>
                  <span><strong>Transparent Pricing:</strong> Know your consultation fee upfront.</span>
                </li>
              </ul>
            </div>
